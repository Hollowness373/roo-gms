...
const FormAuth = <T extends FieldValues>({ type, schema, defaultValues, onSubmit }: Props<T>) => {
  ...
  return (
    <div className='flex flex-col gap-4'>
            <h1 className="text-2xl font-semibold text-white">
                {isSignIn ? 'Welcome back to PANDA' : 'Create your account'}
            </h1>
            <p className="text-light-100">
                {isSignIn ? 'Lorem Ipsum dorem Grab' : 'Please provide and complete all necessary fields'}
            </p>
